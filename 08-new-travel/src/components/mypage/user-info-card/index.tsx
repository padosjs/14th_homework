  ...
  return (
    <div className={styles.container}>
      ...
      <div className={styles.menuSection}>
        <Link
          href="/mypage/history"
          className={`${styles.menuItem} ${pathname === "/mypage/history" ? styles.menuItemActive : ""}`}
        >
        ...
        <Link
          href="/mypage/points"
          className={`${styles.menuItem} ${pathname === "/mypage/points" ? styles.menuItemActive : ""}`}
        >
        ...
        <Link
          ...
          className={`${styles.menuItem} ${pathname === "/mypage/password" ? styles.menuItemActive : ""}`}
        >
