    ...
    return (
        <div className={styles['main-content']}>
            <div className={styles['page-container']}>
                <h1 className={styles['page-title']}>살어리 살어리랏다 쳥산(靑山)애 살어리랏다멀위랑 ᄃᆞ래랑 먹고 쳥산(靑山)애 살어리랏다얄리얄리 얄랑셩 얄라리 얄라</h1>
                <div className={styles['boards-detail-info']}>
                    <div className={styles['boards-detail-profile-date']}>
                        <div className={styles['boards-detail-profile']}>
                            <img src="/assets/images/profileimg.png" className={styles['profile-image-small']} />홍길동
                        </div>
                        <div>2024.11.11</div>
                    </div>
                    <div className={styles['divider']}></div>
                    <div className={styles['boards-deatil-button-group1']}>
                        {/* 이 버튼들은 글로벌 CSS를 사용합니다. */}
