    ...
    return (
        <div className="main-content">
            <div className="page-container">
                <h1 className="page-title">살어리 살어리랏다 쳥산(靑山)애 살어리랏다멀위랑 ᄃᆞ래랑 먹고 쳥산(靑山)애 살어리랏다얄리얄리 얄랑셩 얄라리 얄라</h1>
                <div className='boards-detail-info'>
                    <div className='boards-detail-profile-date'>
                        <div className='boards-detail-profile'>
                            <img src="/assets/images/profileimg.png" className="profile-image-small" />홍길동
                        </div>
                        <div>2024.11.11</div>
                    </div>
                ...
                <div className='detail-container'>
                    <img src="/assets/images/detailbeach.jpg" className="detail-image1" />
                    ...
                    얄리얄리 얄라셩 얄라리 얄라
                    <img src="/assets/images/detailvideoimage.png" className="detail-image2" />
                </div>
